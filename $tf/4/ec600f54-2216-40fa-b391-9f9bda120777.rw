  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-12 col-md-6 ">
        <div class="about-img"><img src="img/hotels.jpeg" class="img-responsive" alt=""></div>
      </div>
      <div class="col-xs-12 col-md-6">
        <div class="about-text">
          <h2>Bosnian hotels</h2>
          <hr>
          <p>Most importantly: a beautiful hotel is not really a hotel, but a place. A place in which the guest feels comfortable. Bosnian are known for their hospitality and are surely amongst the best hosts in the world.
        <br>
              <br>What Bosnian hotels offer:<br>
              <br>
            1. Cheap prices<br>
            2. Nice locations<br>
            3. Great conncetions to other city parts<br>
            4. Charm<br>
            </p>
        </div>
      </div>
...
<div id="restaurant-menu">
  <div class="section-title text-center center">
    <div class="overlay">
      <h2>Hotels</h2>
      <hr>
      <p>Find the best Hotel Deals in the area.</p>
    </div>
  </div>
